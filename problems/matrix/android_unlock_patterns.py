"""
https://leetcode.com/problems/android-unlock-pattern
"""
class Solution:
    """
    ...
    def numberOfPatterns(self, m: int, n: int) -> int:
        ...
        ans = [0]  # This is how I am able to update the answer. Cannot update as an int variable unless initialized by object.
