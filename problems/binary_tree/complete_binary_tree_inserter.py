...
class CBTInserter:
    ...
    A complete binary binary_tree is a binary binary_tree in which every level, except possibly the last, is completely filled,
    ...
    def __init__(self, root: TreeNode):
        """
        initializes the data structure on a given binary_tree with head node root
        """
    ...
    def insert(self, v: int) -> int:
        """
        will insert a TreeNode into the binary_tree with value node.val = v so that the binary_tree remains complete,
    ...
    def get_root(self) -> TreeNode:
        """
        Return head node of the binary_tree
        """
